...
export default function addProduct() {
    ...
    const onSubmit = async (e) => {
        ...
        console.log(image);
        // console.log(image);
        if (image_url === '', name === '' || description === '' || categoryId === '' || unit === '' || price === '') {
        ...
        addProduct(image, name, description, categoryId, unit, quantity, price, manufacturer, dateAdded);
                            ...
                            <div className='flex-1 mt-14 mb-14 mr-32'>
                                ...
                                <div class="overflow-x-auto relative mt-7 flex justify-start">
                                    <form className="w-3/5 mt-4 ml-24" onSubmit={onSubmit}>
                                        ...
                                        <div class="mb-6">
                                            <label htmlFor="image_url" class="btn btn-primary px-7 py-2 bg-[#243C74] text-white font-bold shadow-md rounded-md">Click to add image</label>
                                        </div>
                                        <div class="mb-6">
                                            <input
                                                type="text"
                                        ...
                                        <div class="mt-10">
                                            <button type="submit" class="btn btn-primary px-14 py-2 bg-[#243C74] text-white font-bold shadow-md rounded-md">Submit</button>
                                            <button type="reset" href="/SellerDashboard/stock" class="btn btn-primary px-14 py-2 bg-white border border-gray-500 text-gray-900 font-bold shadow-md rounded-md ml-7">Cancel</button>
                                        </div>
                                    </form>
